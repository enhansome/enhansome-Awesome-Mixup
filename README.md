...
* **Milking CowMask for Semi-Supervised Image Classification**<br>
  *Geoff French, Avital Oliver, Tim Salimans*<br>
  ...
  \[[Code](https://github.com/google-research/google-research/tree/master/milking_cowmask) ⭐ 38,642 | 🐛 1,989 | 🌐 Jupyter Notebook | 📅 2026-08-27]
   <details close>
...
This repository is built using the [OpenMixup](https://github.com/Westlake-AI/openmixup) ⭐ 658 | 🐛 7 | 🌐 Python | 📅 2025-10-15 library and [Awesome README](https://github.com/matiassingers/awesome-readme) ⭐ 21,388 | 🐛 1 | 📅 2026-08-20 repository.

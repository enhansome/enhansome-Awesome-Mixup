...
* **FMix: Enhancing Mixed Sample Data Augmentation**<br>
  *Ethan Harris, Antonia Marcu, Matthew Painter, Mahesan Niranjan, Adam Prügel-Bennett, Jonathon Hare*<br>
  ...
  \[[Code](https://github.com/ecs-vlc/FMix) ⭐ 339 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2021-03-26]
   <details close>
...
* **Milking CowMask for Semi-Supervised Image Classification**<br>
  *Geoff French, Avital Oliver, Tim Salimans*<br>
  ...
  \[[Code](https://github.com/google-research/google-research/tree/master/milking_cowmask) ⭐ 38,526 | 🐛 1,989 | 🌐 Jupyter Notebook | 📅 2026-08-12]
   <details close>
...
* **Rank-N-Contrast: Learning Continuous Representations for Regression**<br>
  *Kaiwen Zha, Peng Cao, Jeany Son, Yuzhe Yang, Dina Katabi*<br>
  ...
  \[[Code](https://github.com/kaiwenzha/Rank-N-Contrast) ⭐ 138 | 🐛 6 | 🌐 Python | 📅 2024-02-28]
...
* **Dual Mixup Regularized Learning for Adversarial Domain Adaptation**<br>
  *Yuan Wu, Diana Inkpen, Ahmed El-Roby*<br>
  ...
  \[[Code](https://github.com/YuanWu3/Dual-Mixup-Regularized-Learning-for-Adversarial-Domain-Adaptation) ⭐ 12 | 🐛 1 | 🌐 Python | 📅 2021-04-08]
...
* **Augmenting Data with Mixup for Sentence Classification: An Empirical Study**<br>
  *Hongyu Guo, Yongyi Mao, Richong Zhang*<br>
  ...
  \[[Code](https://github.com/dsfsi/textaugment) ⭐ 443 | 🐛 1 | 🌐 Python | 📅 2026-03-04]
...
* **MixText: Linguistically-informed Interpolation of Hidden Space for Semi-Supervised Text Classification**<br>
  *Jiaao Chen, Zichao Yang, Diyi Yang*<br>
  ...
  \[[Code](https://github.com/GT-SALT/MixText) ⭐ 355 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2020-06-05]
...
This repository is built using the [OpenMixup](https://github.com/Westlake-AI/openmixup) ⭐ 658 | 🐛 7 | 🌐 Python | 📅 2025-10-15 library and [Awesome README](https://github.com/matiassingers/awesome-readme) ⭐ 21,310 | 🐛 1 | 📅 2026-07-27 repository.
